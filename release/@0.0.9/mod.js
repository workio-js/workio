...
// src/WorkerTemp.js
var WorkerTemp_exports = {};
__export(WorkerTemp_exports, {
...
async function workerTemp() {
  ...
  ;
  let sudoKey = "\0sudoKey\0", publicFunctionInterface = {}, initialized = false, pendingTask = [], processTask = async function(data) {
...
var init_Worker = __esm(async () => {
  ...
  WorkioWorker = class {
    constructor({workerFn, constructorConfig, workerArgs}) {
      const pFIIndex = {}, sudoKey = random642(), personalTaskPool = new TaskPool2(), workerInstance = new Worker(scriptURL2(`(${workerTemp2.toString().replace(/"\\0workerFn\\0"/, "(" + workerFn.toString() + ")").replace(/\\0sudoKey\\0/, sudoKey).replace(/\\0base\\0/, (() => {
        switch (runtimeKey3) {
          case "other":
